...
if( !class_exists('MHRS_My_Bookings_SC') ){

	class MHRS_My_Bookings_SC{
		...
		public function __construct(){
			...
			add_shortcode( 'mhrs_my_bookings', array( $this, 'my_bookings_sc' ) );
					...
					<table class="mhrs_booking_summary">
						...
						<tr>
							...
							<td colspan="6" class="right_align_cls">
								...
								<?php _e( 'Tax', 'mhrs' ); ?>(<?php echo $b['tax_percentage']; ?>%)
