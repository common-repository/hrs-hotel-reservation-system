			...
			if( $all_rooms ){
				foreach( $all_rooms as $all_room ){
					...
					if( !empty( $hotel_id ) && is_numeric( $hotel_id ) ){
						if( self::is_published( $hotel_id, 'mhrs_hotels' ) ){
							...
							if( !empty( $city_id ) && self::is_published( $city_id, 'mhrs_city' ) ){
								$p = get_post( $city_id );
								$id = $p->ID;
								$slug = $p->post_name;
								$title = $p->post_title;
							...
							if( !empty( $state_id ) && self::is_published( $state_id, 'mhrs_state' ) ){
								$p = get_post( $state_id );
								$id = $p->ID;
								$slug = $p->post_name;
								$title = $p->post_title;
							...
							if( !empty( $country_id ) && self::is_published( $country_id, 'mhrs_country' ) ){
