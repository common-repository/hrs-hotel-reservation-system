<?php
/**
 * The template for displaying Archive for mhrs_hotels post type
...
if ( $query->have_posts() ) {
	...
	while ( $query->have_posts() ) {
		$query->the_post();
		$id = get_the_ID();
		$hotels[$id] = mhrs_get_hotel_detail( $id );
	}
			...
			<div class="mhrs_wrap_inner_content">
            	<div class="main_image_cls">
                    ...
                    <div class="full_size_slider" style="cursor:pointer">
                        ...
                        <img src="<?php echo MHRS_PLUGIN_URL."/assets/img/view_full_screen.png"; ?>"/>
                        </span>
						...
						<button class="next_large arrow-cls"><img src="<?php echo MHRS_PLUGIN_URL."/assets/img/arrow-right.png"; ?>"/></button>                            </div>
                        </div>
                    </div>
